...
//! [`crate::two_d::coordinate_vector2d`], [`crate::three_d::coordinate_vector3d`],
//! [`crate::two_d::triangle2d`], and [`crate::three_d::surface_mesh3d`].
//!
...
//!
//! ```rust
//! use lib_jsl_geometry::common::{IsGeometryTable, IsGeometryTableBase, PointId};
//! use lib_jsl_geometry::concrete::{GeometryTableRegistry, FreeVector3D, Line3D, CoordinateVector3D};
//! use lib_jsl_geometry::one_d::IsLine;
//!
...
pub use crate::one_d::{Line1D, Plane1D, CoordinateVector1D, UnitVector1D};
...
pub use crate::registry::GeometryTableRegistry;
/// Re-exported keyed table implementations used by the concrete geometry graph.
pub use crate::tables::{HashGeometryTable, SharedGeometryTable};
...
mod tests {
    ...
    use crate::coordinate_systems::{CoordinateSystem2D, CoordinateSystem3D};
    use crate::one_d::IsLine;
    use crate::three_d::{IsMesh, IsTetrahedron};
    ...
    fn tetrahedron_trait_contract_smoke_test() {
        ...
        where
            ...
            <T as HasEdges>::Edge: crate::one_d::IsLine<'a, CoordinateVector3D>,
        {
        }
