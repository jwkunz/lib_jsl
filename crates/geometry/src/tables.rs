...
//! hash-backed implementation of [`IsGeometryTable`](crate::common::IsGeometryTable)
//! along with a shared-handle wrapper for cases where multiple primitives need to borrow the same
//! table.

use crate::common::{GeometricPrimitive, IsGeometryKey, IsGeometryTable};
use serde::Serialize;
...
///
/// This is the default concrete table type used by [`GeometryTableRegistry`](crate::registry::GeometryTableRegistry).
